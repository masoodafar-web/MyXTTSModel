...
def main():
    ...
    print("")
    print("# Voice cloning with adjusted sampling temperature for consistency")
    print("python inference_main.py \\")
    ...
    print("")
    print("# High-quality voice cloning with a pretrained speaker encoder")
    print("python inference_main.py \\")
    print("    --text \"High fidelity voice replication\" \\")
    print("    --reference-audio high_quality_speaker.wav \\")
    print("    --clone-voice \\")
    print("    --use-pretrained-speaker-encoder \\")
    print("    --speaker-encoder-type ecapa_tdnn \\")
    ...
    print("   • Larger speaker embeddings for stronger conditioning")
    print("   • Optional pretrained speaker encoder integration")
    print("   • Support for multiple reference audios when cloning")
    ...
    print("   • Enable pretrained speaker encoder for tighter similarity")
    ...
    print("   • Reduce max_attention_sequence_length when processing long inputs")
